...
export default function App() {
  ...
  {/* Shopping cart FAB — hidden while meal plan panel is open */}
  {shoppingList.length > 0 && !showMealPlanPanel && (
    <button className={`shopping-cart-fab${planCount > 0 ? " sidebar-visible" : ""}`} onClick={() => setShowShoppingSheet(true)} aria-label="Indkøbsliste">
